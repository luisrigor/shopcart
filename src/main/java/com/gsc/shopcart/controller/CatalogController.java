...
public class CatalogController {
    ...
    @ResponseBody
    public ResponseEntity<CreateOrderResponseDTO> createOrder(@AuthenticationPrincipal UserPrincipal user,
                                         @Valid @RequestBody OrderDataDTO orderData) {
        return ResponseEntity.status(HttpStatus.OK).body(catalogService.createOrder(user,orderData));
    }
