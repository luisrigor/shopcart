...
public interface CbusDealerRepository extends JpaRepository<CbusDealer, Integer> {

    @Query(value = "SELECT D.OID_DEALER, D.DESIG_ENTIDADE, D.END_ENTIDADE  FROM CBUS_DEALERS D,USER_ENTITY UE WHERE UE.ID_ENTITY = D.ID_ENTIDADE " +
