...
@Builder
@Entity
@Table(name = "LEXUS_USER_ENTITY_PROFILE")
public class LexusUserEntityProfile {
    ...
    @Column(name = "ID_VENDEDOR_LEXUS")
    private Integer idVendedorLexus;
    ...
    @Column(name = "SERVICO_LEXUS_UTILIZADOR")
    private String servicoLexusUtilizador;
    ...
    @Column(name = "COD_REDE_LEXUS")
    private Integer codRedeLexus;
